	...
	<body>
		...
		<div id = "wrapper" width = 100%; style="margin: 0 auto;">
			...
			<div id = div1; style="padding-top:180px; width:100%; margin: 0 auto;" > 
				<center>     
					<p class="headers">Welcome! Please select a quiz to take.<br>Current CRN: <?php echo $_SESSION['crnNumber']; ?></p>
					<table border="0">
						<tr>
							<!-- 		<td><span class="choices">
								<a href = http://web.njit.edu/~ac422/cs490/front/takeexam.php>			Take your Exam part I [Multiple choice]</a></span></td>
							</tr> -->
							...
							<tr>
								...
								<script type="text/javascript">
									...
									document.write("<form action='stageExam.php' method='post' name='dropDown' class='dropDown'>");		// ** MAKE SURE TO ADD FORM BEGINNING
